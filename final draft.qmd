...
-   Then, we randomly shuffled the data 10,000 times to see how often the difference in proportions produced was as large as the observed difference. \vspace{0.2cm}
...
-   We conclude that the system change had a statistically significant negative effect on proportion of members attending their first event within 30 days. \vspace{0.2cm}
------------------------------------------------------------------------
